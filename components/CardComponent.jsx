...
export const CardComponent = ({imageSource, title, buttonText, buttonTextColor, onPress}) => {
  ...
  return (
      ...
      <Card style={styles.container}>
        ...
        <Image source={require('../assets/images/fire2.png')} style={styles.backgroundImage} />
      </Card>
  );
};
