  ...
  return (
    <View>
      <View style={{backgroundColor: customTheme.colors.primary, paddingVertical: h(1.4), flexDirection: 'row', alignItems: 'center'}}>
        <Link href={"/forgot"} style={{paddingRight: 15, paddingLeft: w(4)}}>
          <Icon name="arrow-left" 
            color={customTheme.colors.textWhite}  size={23}>
          </Icon>
        </Link>
        <Heading text="Secret Code" alignStyle={{color: customTheme.colors.textWhite, fontWeight: 600, fontSize: f(2.5)}} />
      </View>
      <View style={{paddingVertical: h(7), paddingHorizontal: w(4)}}>
        <Heading text="Please enter secret code" alignStyle={{fontWeight: 300, fontSize: f(2), paddingBottom: h(4)}} />
        <InputComponent
          mode="outlined"
          label=""
